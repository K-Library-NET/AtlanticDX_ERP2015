...
namespace AtlanticDX.ERP.Areas.Finances.Controllers
{
    ...
    public class MainlandLogisticsFeeController : PrivilegeFramework.NavigationProps.NavigationLoopSolvedController// Controller
    {
        // GET: MainlandLogisticsFee
        ...
        public JsonResult Index(int page = 1, int rows = 10)
        {
            var list1 = db.AccountsPayables.Where(m => m.EventType ==
                YuShang.ERP.Entities.Finances.AccountingEventType.MainlandLogisticsFee);

...
namespace AtlanticDX.ERP.Areas.Finances.Controllers
{
    ...
    public class ImportBalancedPaymentController : PrivilegeFramework.NavigationProps.NavigationLoopSolvedController// Controller
    {
        // GET: ImportBalancedPayment
        ...
        public JsonResult Index(int page = 1, int rows = 10)
        {
            var list1 = db.AccountsPayables.Where(m => m.EventType ==
                YuShang.ERP.Entities.Finances.AccountingEventType.ImportBalancedPayment);

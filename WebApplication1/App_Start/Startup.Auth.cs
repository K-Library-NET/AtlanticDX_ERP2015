...
namespace WebApplication1
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<ApplicationDataSource>( 
                ApplicationDbContext.CreateMySqlDataSource2);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    ApplicationUserManager, ApplicationUser, int>(
                        validateInterval: TimeSpan.FromMinutes(30),
                        regenerateIdentityCallback: (manager, user) => user.GenerateUserIdentityAsync(manager),
                getUserIdCallback: (user) => { return user.GetUserId<int>(); }
                )
                }
            });
        ...
        private async void AddRoles()
        {
            ...
            ApplicationUserManager usermanager = new ApplicationUserManager(
                ...
                //ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>
                   (new ApplicationDataSource()));// (new ApplicationDbContext()));
            try
            {

namespace TestEFwithMySQL.Migrations
{
    using System;
    ...
    internal sealed class Configuration : 
        DbMigrationsConfiguration<TestEFwithMySQL.Models.ApplicationDbContext>
    {
        public Configuration()
        {
            ...
            migrator.Update("AspnetIdentity");
        }

        protected override void Seed(
            TestEFwithMySQL.Models.ApplicationDbContext context)
        {
